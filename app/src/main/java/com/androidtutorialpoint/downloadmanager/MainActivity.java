...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.DownloadImage:
                Uri image_uri = Uri.parse("https://my-cpe.com/uploads/webinar_image/1559929190INTERNATIONAL-TAX-FOR-THE-GROWING-BUSINESS-1.jpg");
                Image_DownloadId = DownloadData(image_uri, v);
                break;

            //Download Music
            case R.id.DownloadMusic:
                Uri music_uri = Uri.parse("https://my-cpe.com/uploads/webinar_doc/1557225745McCormick_InternationalTax.pdf");
    ...
    private long DownloadData(Uri uri, View v) {
        ...
        if (v.getId() == R.id.DownloadMusic)
            request.setDestinationInExternalFilesDir(MainActivity.this, Environment.DIRECTORY_DOWNLOADS, "AndroidTutorialPoint.pdf");
